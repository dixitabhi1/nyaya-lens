      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
        <div className="space-y-6 mb-6">
          {messages.length === 0 && !loading && (
            <EmptyState message="Ask your first legal question" sub="Get AI-powered answers grounded in Indian law" />
          )}
        ...
        <div className="space-y-4">
          <UserHistoryPanel
            ...
            onSelect={(item) => setQuestion(item.prompt_excerpt || item.title)}
          />
        </div>
      </div>
    </div>
